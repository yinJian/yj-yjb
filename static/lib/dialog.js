...
(function(root, factory) {
	...
	$.Dialog = function(settings) {
		...
		if (settings.type === "confirm") {
			...
			action = '<div class="select-action-bar"><span class="sab-cancel ui-confirm-no text-blue font-15" style="float:left;">取消</span><span class="font-17">'+settings.custom_title+'</span><span class="sab-cancel text-blue ui-confirm-submit font-15" style="float:right;">确定</span></div>';

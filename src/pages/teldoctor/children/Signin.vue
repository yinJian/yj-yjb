  ...
  <div class="signin-container">
    ...
    <div class="signin-form">
      <div class="form-group">
        <input type="text" name="name" v-model="username" class="lg-input" placeholder="姓名（请输入真实姓名）">
      </div>
      <div class="form-group">
        <select class="idcard" v-model="selectedID">
          <option v-for="IDlist in IDtype" :value="IDlist.IDcode">{{IDlist.IDname}}</option>
        </select>
        <input type="text" name="name" maxlength="18" class="lg-input" v-model="idNumber" placeholder="请输入证件号">
      </div>
      <div class="form-group">
        <div class="area-code">
          <span>＋86</span>
      ...
      initUserinfo () {
        if (this.userinfo) {
          if (this.$route.query.redirect) {
            ...
            this.$router.push('/teldoctor/home');
          }
        }
      },
      startTimer () {
